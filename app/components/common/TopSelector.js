...
class TopSelector extends PureComponent {
    ...
    render() {
        return (
            <View style={[{height:81-37,marginBottom:2,width:SCREEN_WIDTH,alignItems:'center',backgroundColor:'white',}]}>
                {/*<DateTitle />*/}
                <View style={[{width:SCREEN_WIDTH,flexDirection:'row',justifyContent:'space-around',
                    ...
                    borderTopWidth:1,borderBottomWidth:1,height:44},]}>
                    ...
                    <View style={[styles.optionStyle,{backgroundColor:'white'}]}>
                        <Text style={[{color:this.state.selectOption==0?globalcolor.titleBlue:globalcolor.textBlack,height:40,
                            lineHeight:40,fontSize:normal_font_size,},]}>实时</Text>
                    </View>
                    </TouchableOpacity>
                    <TouchableOpacity style={[styles.optionStyle,]} onPress={()=>{this._changeMTag(1,-1);}}>
                    <Text style={[{color:this.state.selectOption==1?globalcolor.titleBlue:globalcolor.textBlack,height:40,
                        lineHeight:40,fontSize:normal_font_size,},]}>分钟</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={[styles.optionStyle,]} onPress={()=>{this._changeMTag(2,-1);}}>
                    <Text style={[{color:this.state.selectOption==2?globalcolor.titleBlue:globalcolor.textBlack,height:40,
                        lineHeight:40,fontSize:normal_font_size,},]}>小时</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={[styles.optionStyle,]} onPress={()=>{this._changeMTag(3,-1);}}>
                    <Text style={[{color:this.state.selectOption==3?globalcolor.titleBlue:globalcolor.textBlack,height:40,
