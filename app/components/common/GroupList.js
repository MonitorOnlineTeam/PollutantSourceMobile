...
@connect(({datapreview})=>({groupItems:datapreview.groupItems,
...
class GroupList extends Component {
    ...
    _renderItem = ({item}) => {
        ...
        return <TouchableOpacity style={[{flexDirection:'row',borderBottomColor:globalcolor.borderLightGreyColor,borderBottomWidth:0.5,
                            justifyContent:'center',alignItems:'center',height:32,},]} onPress={()=>{
    ...
    render() {
        ...
        return (
            <View style={[styles.container]}>
                ...
                {this.props.spinning?<LoadingComponent Message={'正在努力加载数据'}/>:
