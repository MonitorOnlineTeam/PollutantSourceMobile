...
//console.log('======');
@connect(({router,datapreview})=>({modalVisible:router.modalVisible ,searchType:datapreview.searchType,seasons:datapreview.seasons,value:datapreview.searchDateValue}))
      ...
      return (
            ...
            <Animated.View style={[styles.tip,{marginTop:15,} , {transform: [{
              ...
              <View style={{backgroundColor:'white',height:WINDOW_HEIGHT,width:SCREEN_WIDTH,}}>
                ...
                <DefinedDatePicker mGetSearchType={()=>{return this.props.mGetSearchType();}} ref="definedDatePicker" style={{width:SCREEN_WIDTH,marginTop:64,}}/>
              </View>
