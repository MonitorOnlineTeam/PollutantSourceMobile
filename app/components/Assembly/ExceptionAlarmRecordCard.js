      ...
      <View style={{width:'100%',flexDirection:"row"}}>
        ...
        {/* 主块 */}
          <View style={styles.MainView}>
            ...
            <Button style={{backgroundColor:'#FABE50'}}><Text style={{color:'white',fontSize:15}}>督办</Text></Button>
            </View>
            <View style={{width:'49.9%',zIndex:300,position:'relative'}}>
            <Button style={{backgroundColor:'#FABE50'}}><Text style={{color:'white',fontSize:15}}>{this.state.OperationPerson}</Text></Button>
            </View>
          </View>
          </View>
      </View>
