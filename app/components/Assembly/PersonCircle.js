...
export default class PersonCircle extends Component {
    ...
    render() {
        return (
            <View style={{
                width: 62, height: 80, alignItems: "center",
                ...
                <WhiteSpace size="lg" />
                    <Text style={{fontSize:11,color:"#676767"}}>{this.props.personname}
                    </Text>
                    {
                        this.props.isnews?                 <View style={{
                            backgroundColor: "#FF0000",
                            alignItems: "stretch", borderRadius: 50, width: 5, height: 5
                  }}></View>:<View></View>
