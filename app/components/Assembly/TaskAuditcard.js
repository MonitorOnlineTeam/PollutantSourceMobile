        ...
        <View style={styles.MainView}>
          ...
          <View style={styles.SpecificView}>
            <View style={styles.RowView}>
              ...
              <Text style={styles.CosntentText}>{this.props.dateTime}</Text>
            </View>

             <View style={styles.RowView}>
              <WingBlank size="lg" />
            
              <Text style={[styles.ContentText, styles.flexStyle]}>运维人：{this.props.operationperson}</Text>
            </View>
            ...
            <View style={styles.RowView}>
              ...
              <Text style={[styles.ContentText, styles.flexStyle]}>电话：{this.props.phone}</Text>
              {/* <Text style={[styles.ContentText, styles.flexStyle]}></Text> */}
