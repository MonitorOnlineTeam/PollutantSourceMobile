          ...
          <View style={styles.tabs}>
            ...
            <ScrollView style={styles.tabView}>
              <View style={styles.MainView} >
                ...
                <View>
                  {/* 处理说明输入框 */}
                  <TextInput style={styles.TitleInput} multiline={true} placeholder="处理说明"
              ...
              <View style={{ marginBottom: "2%" }}>
                {/* 按钮 */}
                <CenterButton title={'气态分析仪运行状况检查记录表'}
                  bgColor={"#FFFFFF"}
                  TColor={'#7C7C7C'}
                  bwidth={1}
                  bColor={'#DDE6ED'}
              ...
              <View style={styles.MainView} >
                ...
                <View style={{ flexDirection: "row", padding: "3%", flexWrap: 'wrap', }}>
                  {/*--------------重复样式---华丽的分割线开始-----------------  */}
                  <Image
                    style={styles.Img}
