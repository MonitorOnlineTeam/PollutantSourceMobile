      ...
      <View>
        ...
        <View style={[styles.MainView, styles.MainViewbg]}>
          <View style={{ padding: 12, flexDirection: 'row' }}>
            <Text style={{ fontSize: 14, color: '#434343', flex: 1 }}>
              运维人员姓名:王丹丹
            </Text>

            <TouchableOpacity>
              <Text style={{ fontSize: 14, color: '#26C439' }}>详情信息>></Text>
            </TouchableOpacity>
            <WingBlank size="sm" />
          </View>
          ...
          <TouchableOpacity style={{ width: '100%', height: 94 }}>
            <List>
              ...
              >
                <List.Item
                  arrow="down"
                  activeStyle={{ borderTopColor: '#FFFFFF' }}
                >
                  月
                </List.Item>
              </DatePicker>
            ...
            <List>
              ...
              >
                <List.Item
                  arrow="down"
                  activeStyle={{ border: '#FFFFFF', borderWidth: 0 }}
                >
                  周
                </List.Item>
              </Picker>
