...
export default class AlarmInfoData extends Component {
  ...
  render() {
    //数据
    const persons = [
      { name:"大唐集团-废气排口",time:"2018年10月8日 16:20:27",type:"报警" ,c: '11', nr: "烟气分析仪型号CEMS1608081501" },
      { name:"大唐集团-废气排口",time:"2018年10月8日 16:20:27",type:"报警" ,c: '11', nr: "烟气分析仪型号CEMS160808150" },
      { name:"大唐集团-废气排口",time:"2018年10月8日 16:20:27",type:"报警" ,c: '11', nr: "烟气分析仪型号CEMS160808150" },
      { name:"大唐集团-废气排口",time:"2018年10月8日 16:20:27",type:"报警" ,c: '11', nr: "烟气分析仪型号CEMS160808150" },
      { name:"大唐集团-废气排口",time:"2018年10月8日 16:20:27",type:"报警" ,c: '11', nr: "烟气分析仪型号CEMS160808150" },
      { name:"大唐集团-废气排口",time:"2018年10月8日 16:20:27",type:"报警" ,c: '11', nr: "烟气分析仪型号CEMS160808150" },
      { name:"大唐集团-废气排口",time:"2018年10月8日 16:20:27",type:"报警" ,c: '11', nr: "0" },
      { name:"大唐集团-废气排口",time:"2018年10月8日 16:20:27",type:"报警" ,c: '11', nr: "1" },
      { name:"大唐集团-废气排口",time:"2018年10月8日 16:20:27",type:"报警" ,c: '11', nr: "1" },
      ...
      <View style={{}}>
        <ScrollView style={{ marginBottom: "3%", height: "90%" }}>
        {
           persons.map((item,key)=>
           {
               ...
               return(
               <AlarmInfoDataCard  title={item.name} dateTime={item.time}
               number={item.c}
               alarmType={item.type}
               key={key}
               contentText={item.nr}
