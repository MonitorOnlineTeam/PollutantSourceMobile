  ...
  render() {
    return (
      <View>
        ...
        <Text style={ styles.TitleText}>任务单号：</Text><Text style={styles.ContentText}>96658688955</Text>
        </View>

        <View style={styles.ContentView}>
        <Text style={{color:"#2196F3",fontSize:13}}>排口：废气排口</Text>
        </View>  

         {/*--------重复样式---------美丽的分割线-----------------  */}
        <View style={styles.ContentView}>
        <Text style={ styles.TitleText}>企业：</Text><Text style={styles.ContentText}>大唐集团（三门峡）城市供热有限公司</Text>
        </View>
        <View style={styles.ContentView}>
        <Text style={ styles.TitleText}>城市：</Text><Text style={styles.ContentText}>三门峡</Text>
        </View>
        <View style={styles.ContentView}>
        <Text style={ styles.TitleText}>创建人：</Text><Text style={styles.ContentText}>成云</Text>
        </View>
        <View style={styles.ContentView}>
        <Text style={ styles.TitleText}>创建时间：</Text><Text style={styles.ContentText}>2018-08-01 10:00:00</Text>
        </View>
     {/*--------------重复样式---美丽的分割线结束-----------------  */}
     <View style={styles.ContentView}>
        <Text style={ styles.TitleText}>任务内容：</Text>
        <Text style={{color:"#404040",fontSize:13,letterSpacing:0.5, flexShrink: 1,lineHeight:23}}>烟气分析仪型号CEMS16066656464发生
        故障报警，开始时间2018-7-24 11:10:00，结束时间2018-7-24 16:18：00；烟气分析仪型号烟气分析仪型号CEMS16066656464发生连续值报警
...
const styles = StyleSheet.create({
  ...
  ScrollTitleView:
  {
    flexDirection:"row",padding:"2%",backgroundColor:"#F5FAFE",borderRadius:5
  },
  ScrollTitleText:{
    flex:1,fontSize:13
