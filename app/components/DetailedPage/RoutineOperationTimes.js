                ...
                <View style={{ width: '90%' }}>
                    <View style={{ flexDirection: 'row', width: '100%', marginLeft: '5%', flexDirection: 'row' }}>
                        ...
                        <View style={{ width: '36%', flexDirection: 'row' }}>
                            <View style={{ flex: 4 }}>
                                <Text style={{ fontSize: 13, lineHeight: 50, textAlign: 'right' }}>实际例行次数</Text>
                            </View>
                        ...
                        <View style={{ width: '36%', flexDirection: 'row' }}>
                            <View style={{ flex: 4 }}>
                                <Text style={{ fontSize: 13, lineHeight: 50, textAlign: 'right' }}>计划例行次数</Text>
                            </View>
                            <View style={{ width: '5%', height: 50, alignItems: 'center', justifyContent: 'center', flex: 1 }}>
                                <Image
                                    style={{ width: 10, height: 10 }}
                        ...
                        >
                            ...
                            >
                                <View style={{ flexDirection: 'row' }}>
                                    <View style={{ width: '1%', backgroundColor:item.color, height: 40, borderRadius: 3 }} />
                                    <View style={{ flexDirection: 'row', width: '99%', backgroundColor: '#FFFFFF', height: 40,borderBottomRightRadius:3,borderTopRightRadius:3 }}>
                                        <View style={{ width: '28%' }}>
                                        ...
                                        <View style={{ width: '36%' }}>
                                            <Text style={{ textAlign: 'center', fontSize: 14, lineHeight: 40 }}>{item.Processed}</Text>
                                        </View>
                                    </View>
                                </View>
