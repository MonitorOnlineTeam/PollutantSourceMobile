          ...
          >
            ...
            >
              <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                ...
                />
                <WingBlank size="sm" />
                <Text style={{ fontSize: 14, color: '#000000' }}>故障</Text>
              </View>
              {/* 线 */}
            </View>
            <View
            ...
            >
              <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                ...
                />
                <WingBlank size="sm" />
                <Text style={{ fontSize: 14, color: '#000000' }}>超标</Text>
              </View>
              {/* 线 */}
            </View>
            <View
            ...
            >
              <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                ...
                />
                <WingBlank size="sm" />
                <Text style={{ fontSize: 14, color: '#000000' }}>停产</Text>
              </View>
              {/* 线 */}
            </View>
            <View
            ...
            >
              <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                ...
                />
                <WingBlank size="sm" />
                <Text style={{ fontSize: 14, color: '#000000' }}>正常</Text>
              </View>
              {/* 线 */}
            </View>
          </View>
