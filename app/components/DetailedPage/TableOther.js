            ...
            <View style={{
                ...
                <View style={{ flexDirection: "row" }}>
                    ...
                    <View style={{ flex: 3, flexDirection: "row", alignItems: "center" }}>
                        <Text style={{ fontSize: 14, color: "#000000" }}>企业</Text>
                    </View>
                    <WingBlank />
                    <View style={{ flex: 1, flexDirection: "row", alignItems: "center" }}>
                        <Text style={{ fontSize: 14, color: "#000000" }}>排口</Text>
                    </View>
                    <WingBlank />
                    {/* 第二标题 */}
                ...
                <ScrollView style={{}}>
                    ...
                    <TouchableOpacity style={{ flexDirection: "row" }} onPress={(event) => {
                        ...
                        <View style={{ flex: 1, flexDirection: "column" }}>
                            <View >
                                <View style={{ flexDirection: "row", alignItems: "center" }}>
                                    <Text style={{ fontSize: 13, color: "#000000" }}>锅炉小号</Text>
                                </View>
                            </View>
                            <WhiteSpace />
                            <WingBlank size="sm" />
                    ...
                    <TouchableOpacity style={{ flexDirection: "row" }}>
                        ...
                        <View style={{ flex: 1, flexDirection: "column" }}>
                            <View >
                                <View style={{ flexDirection: "row", alignItems: "center" }}>
                                    <Text style={{ fontSize: 13, color: "#000000" }}>小号</Text>
                                </View>
                            </View>
                            <WhiteSpace />
                            <WingBlank size="sm" />
