            ...
            <View style={styles.view1}>
                <View style={styles.view2}>
                            ...
                            <View style={{ marginTop: '5%', marginBottom: '5%', flexDirection: 'row' }}>
                                <View style={{ width: '33.3%', height: 100 }}>
                                    <TouchableOpacity onPress={this.types1}>
                                        <View style={[{ width: '90%', alignItems: 'center', justifyContent: 'center', height: 100, backgroundColor: this.state.backgroundColor1, marginLeft: '5%', borderRadius: 5 }]}>
                                            <View>
                                                <Image
                                            ...
                                            <View style={{ marginTop: 3 }}>
                                                <Text style={{ color: this.state.text1 }}>
                                                    停电
                                        </Text>
                                            </View>
                                        </View>
                                ...
                                <View style={{ width: '33.3%', borderRadius: 5, height: 100 }}>
                                    <TouchableOpacity onPress={this.types2}>
                                        <View style={{ width: '90%', alignItems: 'center', justifyContent: 'center', height: 100, backgroundColor: this.state.backgroundColor2, marginLeft: '5%', borderRadius: 5 }}>
                                            <View>
                                                <Image
                                ...
                                <View style={{ width: '33.3%', borderRadius: 5, height: 100 }}>
                                    <TouchableOpacity onPress={this.types3}>
                                        <View style={{ width: '90%', alignItems: 'center', justifyContent: 'center', height: 100, backgroundColor: this.state.backgroundColor3, marginLeft: '5%', borderRadius: 5 }}>
                                            <View>
                                                <Image
                                            ...
                                            <View style={{ marginTop: 3 }}>
                                                <Text style={{ color: this.state.text3 }}>
                                                    停产
                                        </Text>
                                            </View>
                                        </View>
                    ...
                    <View style={{ alignItems: 'center', marginTop: 10 }}>
                        <Button
                            inline={true}
                            style={{ width: SCREEN_WIDTH - 70, borderRadius: 20, height: 45, backgroundColor: '#5F7CFC' }}
