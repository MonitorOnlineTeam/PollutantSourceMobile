...
export const kindCode = equitmentCode => {
  ...
  switch (equitmentCode) {
    case '30':
      ...
      break;
    case '18':
      return [['a34004', 'a34002'], ['PM25', 'PM10']];
      break;
    case '26':
      return [
        ['AQI', 'a34004', 'a34002', 'a21004', 'a21026', 'a21005', 'a05024'],
    ...
    case '27':
      return [
        ['ecdj', 'a05', 'a00017', 'a06', 'a21089', 'a99054'],
  ...
  switch (equitmentCode) {
    ...
    case '29':
      return [
        { pname: 'PM25', pcode: 'a34004' },
        { pname: 'PM10', pcode: 'a34002' },
        { pname: 'TSP', pcode: 'a340102' },
        { pname: '噪声', pcode: 'a01015' },
        { pname: '温度', pcode: 'a01001' },
        { pname: '相对湿度', pcode: 'a01002' },
        { pname: '气压', pcode: 's0020' },
    ...
    case '27':
      return [
        { pname: '恶臭等级', pcode: 'ecdj' },
        { pname: 'H2S', pcode: 'a05' },
        { pname: 'NH3', pcode: 'a00017' },
        { pname: 'OU', pcode: 'a06' },
        { pname: '恶臭强度', pcode: 'a21089' },
