...
const api = {
  ...
  system: {
    ...
    getMenu: '/api/rest/PollutantSourceApi/SysMenu/GetSysMenuByUserId', //获取菜单
  ...
  monitorpoint: {
    ...
    GetPointNewRealTimeDataByPollutantType:
      '/rest/OutputAsPointApi/GetPointNewRealTimeDataByPollutantType', //数据一览 实时数据
    GetPointNewMinuteDataByPollutantType:
      '/rest/OutputAsPointApi/GetPointNewMinuteDataByPollutantType', //数据一览 分钟数据
    GetPointNewHourDataByPollutantType:
      '/rest/OutputAsPointApi/GetPointNewHourDataByPollutantType', //数据一览 小时数据
    GetPointNewDayDataByPollutantType:
      '/rest/OutputAsPointApi/GetPointNewDayDataByPollutantType', //数据一览 日数据
