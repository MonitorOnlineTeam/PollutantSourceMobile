        ...
        return (
            <ScrollView style={styles.container} onLayout={this._scrollViewLayout.bind(this)}>
                ...
                <View style={[styles.LoginForm,{height:this.state.contentHeight,}]}>
                    ...
                    <Text style={[{color:globalcolor.whiteFontColor, marginTop:21,fontSize:24,marginBottom:40,}]}>污染源智能分析系统</Text>
                    ...
                    <View style={{flex:1,}}/>
                    <Text style={{ fontSize: 8, color: 'white',marginBottom:4,}}>{'v 1.3.6'}</Text>
